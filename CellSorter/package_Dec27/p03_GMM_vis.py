...
def Sankey_diagram(cluster_before, cluster_after):
    # 距離行列の作成
...
# 差は縮まっているか？？
def Absolute_distance(diff_dict):
...
def System_error(diff_dict, cols=["FSC-A", "APC-A-Compensated"]):
